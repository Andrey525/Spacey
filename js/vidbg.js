var vidbg = function(e) {
    ...
    function a(e, t) {
        return function(e) { if (Array.isArray(e)) return e }(e) || function(e, t) {
            var r = [],
                ...
                o = !1,
                i = void 0;
            try { for (var a, l = e[Symbol.iterator](); !(n = (a = l.next()).done) && (r.push(a.value), !t || r.length !== t); n = !0); } catch (e) { o = !0, i = e } finally { try { n || null == l.return || l.return() } finally { if (o) throw i } }
            return r
    ...
    var s = function() {
        function e(t, r, n) {
            var l = this;
            if (function(e, t) { if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, e), c(this, "createContainer", (function() { l.containerEl = document.createElement("div"), l.containerEl.className = "vidbg-container", l.createPoster(), l.el.appendChild(l.containerEl) })), c(this, "createOverlay", (function() {
                ...
                })), c(this, "createPoster", (function() { l.options.poster && (l.containerEl.style.backgroundImage = "url(".concat(l.options.poster, ")")) })), c(this, "createVideo", (function() {
                    ...
                    void 0 !== n && n.catch((function(e) { console.error(e), console.error("Autoplay is not supported"), l.removeVideo() }))
                })), c(this, "onPlayEvent", (function(e) { l.resize(), l.videoEl.style.opacity = 1 })), c(this, "removeVideo", (function() { l.videoEl.remove() })), c(this, "getVideo", (function() { return l.videoEl })), c(this, "destroy", (function() { l.containerEl.remove() })), c(this, "resize", (function() {
            ...
            this.options = i({}, { mp4: null, webm: null, poster: null, overlay: !1, overlayColor: "#000", overlayAlpha: .3 }, r);
            if (this.attributes = i({}, { controls: !1, loop: !0, muted: !0, playsInline: !0 }, n), !this.options.mp4 && !this.options.webm) return console.error("Please provide an mp4, webm, or both."), !1;
            this.init()
        }
        var t, r, n;
        return t = e, (r = [{ key: "init", value: function() { this.el.style.position = "relative", this.el.style.zIndex = 1, this.createContainer(), this.createVideo(), this.createOverlay(), window.addEventListener("resize", this.resize) } }]) && l(t.prototype, r), n && l(t, n), e
    }();
    t.default = s
}]).default;